...
def parse_args():
    ...
    parser.add_argument('--base_logdir', default='/content/drive/MyDrive/Colab Notebooks/data_disk/deeplearning/few-shot-learning-FD/exp_logs/', help='folder to keep all running files')
    parser.add_argument('--method', default='proto_network_feat_space', help='/content/drive/MyDrive/Colab Notebooks/finetune_last/finetune_whole/feature_knn/matching_network/matching_network_feat_space/matching_network_pretrain'
    ...
    parser.add_argument('--backbone_pretrain_path', default='', type=str, help='pretrain backbone path')  # /content/drive/MyDrive/Colab Notebooks/data_disk/deeplearning/few-shot-learning-FD/exp_logs/matching_network_pretrain/TRAIN/exp__003/saved_model/best_pretrain_backbone.pth
