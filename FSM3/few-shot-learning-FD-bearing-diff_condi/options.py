...
def parse_args():
    ...
    parser.add_argument('--method', default='matching_network_feat_space', help='/content/drive/MyDrive/Colab Notebooks/finetune_last/finetune_whole/feature_knn/matching_network/matching_network_feat_space/matching_network_pretrain')
